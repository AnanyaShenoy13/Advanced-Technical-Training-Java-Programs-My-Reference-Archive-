public class Patient {
    ...
    public void patientDetails(){
        ...
        System.out.println("Register Fees: "+this.pay.regfees);
        System.out.println("Admin Fees: "+this.pay.admFees);
    ...
    public static void main(String[] args) {
        ...
        Patient p1=new Patient("ABC", 21, "11/06/2025", "Jaundice",info,pay);
        p1.patientDetails();
    }
}
